...
import { createProductAction } from "../../../redux/slice/productsSlice";
...
export default function AddProduct() {
  ...
  // select data
   ...
   const { brands: { brands }, loading: brandLoading, error: brandError } = useSelector((state) => state?.brands);
   const { colors: { colors }, loading: colorLoading, error: colorError } = useSelector((state) => state?.colors);

  const handleColorChangeOptions = (colors) => {
            ...
            <form className="space-y-6" onSubmit={handleOnSubmit}>
              ...
              <div>
                ...
                <Select
                  ...
                  isSearchable={true}
                  closeMenuOnSelect={false}
                  onChange={(e) => handleColorChangeOptions(e)}
                />
              </div>
