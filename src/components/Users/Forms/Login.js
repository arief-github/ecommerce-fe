...
import {loginUserAction} from "../../../redux/slice/usersSlice";
...
const Login = () => {
    ...
    const {userInfo, loading, error} = useSelector((state) => state?.users?.userAuth);

    //
    // const isAdminRole = userInfo?.userFound?.isAdmin;
    //
    // if (isAdminRole) {
